...
target and the FinalScoreUITests XCUITest suite cannot run on this machine. Exercise
...
the FinalScoreUITests XCUITest suite cannot run on this machine. Implement UI work
